...
<p><em>Mobile-first 9:16 vertical layout with <strong>⚡ Quanxike9x</strong> brand header, centered core visual & single-line subtitle</em></p>
...
- 📱 **Mobile-First 9:16 Design (1080x1920 @ 30fps):**
  ...
  - **Brand Header:** `⚡ Quanxike9x` badge fixed at `top: 150px`, staying clear of platform search bars.
...
3. **Applies mobile-first visual standards** (centered content, `⚡ Quanxike9x` brand header, single-line chunked subtitles).
