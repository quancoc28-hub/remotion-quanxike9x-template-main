...
<p><em>Giao diện video dọc 9:16 chuẩn mobile với thương hiệu <strong>⚡ Quanxike9x</strong>, bố cục căn giữa và phụ đề 1 dòng</em></p>
...
- **Author:** [Quanxike9x (Quanxike9x)](https://www.facebook.com/Quan82kt/)
- 🎵 **TikTok:** [@Quanxike9x](https://www.tiktok.com/@Quanxike9x)
...
- 📱 **Thiết kế Chuẩn Mobile 9:16 (1080x1920 @ 30fps):**
  ...
  - **Thương hiệu Kênh (Brand Header):** Huy hiệu `⚡ Quanxike9x` cố định tại `top: 150px`, an toàn tuyệt đối, không bị che bởi thanh tìm kiếm.
...
3. **Thiết kế visual mobile** (căn giữa nội dung, huy hiệu thương hiệu `⚡ Quanxike9x`, subtitle 1 dòng gãy gọn).
...
│   │   ├── components/
│   │   │   ├── BrandHeader.tsx  # Huy hiệu kênh Quanxike9x (top: 150px)
