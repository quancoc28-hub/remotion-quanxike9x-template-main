...
3. **Thương hiệu Kênh Phía Trên (Brand Header)**:
   - Luôn hiển thị component thương hiệu `⚡ [CHANNEL_NAME]` ở phía trên ở giữa (`top: 150px`, `left: 50%` translate-x) đọc từ biến môi trường `CHANNEL_NAME` (mặc định: "Quanxike9x") để tránh bị thanh tìm kiếm và tab Đang theo dõi / Dành cho bạn của nền tảng (TikTok, Shorts, Reels) che khuất.
